"""Build final robot_research.json from fetched 2026 reports."""
import json, sys
from datetime import datetime
from collections import Counter

# Load all fetched reports
with open("/tmp/robot_2026_all.json","r",encoding="utf-8") as f:
...
MODULE_KW = {
    ...
    "tendon_material": ["腱绳","PEEK","碳纤维","UHMWPE","轻量化","新材料","形状记忆","SMA","超高分子"],
    "substitution_risk": ["国产替代","竞争格局","技术路线","专利壁垒","特斯拉","波士顿动力","护城河","替代","突破"],
    "valuation": ["PE","估值分析","盈利预测","DCF","目标价","财务模型","业绩预测","利润","增速","CAGR"],
...
def classify(title):
    tl = title.lower()
    scores = {}
    for mid, kws in MODULE_KW.items():
        scores[mid] = sum(1 for kw in kws if kw.lower() in tl)
...
market = {
    ...
    "300024":{"price":15.57,"pe_ttm":-55.39,"pb":6.02,"mcap_yi":243.7,"change_pct":3.39},
    "002747":{"price":31.02,"pe_ttm":230.61,"pb":9.27,"mcap_yi":242.7,"change_pct":5.19},
    "300124":{"price":75.08,"pe_ttm":42.88,"pb":5.8,"mcap_yi":1809.66,"change_pct":1.25},
    "603728":{"price":65.82,"pe_ttm":406.91,"pb":9.27,"mcap_yi":275.71,"change_pct":3.62},
    "002472":{"price":42.86,"pe_ttm":28.69,"pb":3.53,"mcap_yi":320.82,"change_pct":3.55},
    "300660":{"price":33.84,"pe_ttm":72.57,"pb":5.63,"mcap_yi":196.59,"change_pct":4.35},
    "688160":{"price":122.0,"pe_ttm":148.4,"pb":8.62,"mcap_yi":110.82,"change_pct":11.35},
    "002050":{"price":47.51,"pe_ttm":48.92,"pb":6.13,"mcap_yi":1750.36,"change_pct":1.06},
    "689009":{"price":36.36,"pe_ttm":17.66,"pb":3.56,"mcap_yi":203.46,"change_pct":0.36},
    "300580":{"price":23.45,"pe_ttm":41.82,"pb":3.51,"mcap_yi":110.82,"change_pct":3.17},
    "002698":{"price":12.47,"pe_ttm":25.91,"pb":3.02,"mcap_yi":104.78,"change_pct":2.97},
    "603667":{"price":74.34,"pe_ttm":337.71,"pb":7.14,"mcap_yi":272.24,"change_pct":3.48},
    "300403":{"price":11.11,"pe_ttm":31.33,"pb":3.06,"mcap_yi":47.45,"change_pct":6.11},
    "603960":{"price":21.66,"pe_ttm":267.98,"pb":5.06,"mcap_yi":56.79,"change_pct":1.45},
    "002979":{"price":55.69,"pe_ttm":72.58,"pb":9.4,"mcap_yi":123.5,"change_pct":4.76},
    "300748":{"price":31.12,"pe_ttm":58.02,"pb":5.81,"mcap_yi":351.67,"change_pct":1.01},
    "688277":{"price":16.66,"pe_ttm":-35.17,"pb":6.57,"mcap_yi":75.97,"change_pct":-0.48},
    "688218":{"price":43.72,"pe_ttm":-87.74,"pb":5.97,"mcap_yi":50.92,"change_pct":4.27},
}
...
for mid, mi in MN.items():
    ...
    modules[mid] = {
        ...
        "report_count":len(mr),"reports":mr[:20],"orgs":orgs[:15],
    }
...
output = {
    "meta":{
        ...
        "source":"东方财富 reportapi.eastmoney.com (2026年真实研报，三策略获取)",
        "description":f"人形机器人产业链深度研报合集（{len(all_reports)}篇2026年研报，全部来自东财真实数据）",
    },
...
print(f"\nSaved {len(all_reports)} reports to robot_research.json")
for mid, md in modules.items():
    print(f"  {md['title']}: {md['report_count']} reports")
